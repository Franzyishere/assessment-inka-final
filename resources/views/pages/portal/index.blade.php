...
<div class="relative min-h-screen overflow-hidden bg-[#f7f7f8]">
    ...
    <main class="relative z-10 mx-auto max-w-7xl px-5 pb-12 pt-14 sm:px-8 sm:pt-20">
        <div class="max-w-3xl">
            ...
            <p class="mt-4 max-w-2xl text-sm leading-7 text-white/70 sm:text-base">Satu portal terintegrasi untuk mengakses layanan Assessment, Psikotes, dan Rekrutmen PT Industri Kereta Api (Persero).</p>
        </div>

        <section class="mt-12 grid grid-cols-1 gap-5 lg:grid-cols-3">
            <article class="group flex min-h-[360px] flex-col overflow-hidden rounded-3xl border border-white/70 bg-white p-6 shadow-theme-lg transition duration-300 hover:-translate-y-1 hover:shadow-2xl sm:p-7">
                ...
                <div class="mt-7"><p class="text-xs font-semibold uppercase tracking-[0.16em] text-brand-600"></p><h2 class="mt-2 text-2xl font-bold text-gray-900">Assessment</h2><p class="mt-3 text-sm leading-6 text-gray-500">Kelola dan jalankan program assessment, simulasi, monitoring, penilaian, serta rekomendasi secara terintegrasi.</p></div>
            ...
            <article class="flex min-h-[360px] flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white p-6 shadow-theme-md sm:p-7">
                <div class="flex items-start justify-between gap-4"><span class="flex size-14 items-center justify-center rounded-2xl bg-[#fff6e8] text-[#d97706]"><svg class="size-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M9 3h6v3H9zM7 6h10a2 2 0 0 1 2 2v11H5V8a2 2 0 0 1 2-2Zm2 5h6m-6 4h4"/></svg></span><span class="rounded-full bg-warning-50 px-3 py-1 text-xs font-semibold text-warning-700">Segera Hadir</span></div>
                <div class="mt-7"><p class="text-xs font-semibold uppercase tracking-[0.16em] text-[#d97706]"></p><h2 class="mt-2 text-2xl font-bold text-gray-900">Psikotes</h2><p class="mt-3 text-sm leading-6 text-gray-500">Modul pengelolaan dan pelaksanaan tes psikologi akan disiapkan setelah kebutuhan bisnis difinalisasi.</p></div>
                <div class="mt-auto pt-8"><span class="flex w-full cursor-not-allowed items-center justify-center rounded-xl bg-gray-100 px-5 py-3.5 text-sm font-semibold text-gray-400">Menunggu Kebutuhan Client</span></div>
            </article>

            <article class="flex min-h-[360px] flex-col overflow-hidden rounded-3xl border border-gray-200 bg-white p-6 shadow-theme-md sm:p-7">
                <div class="flex items-start justify-between gap-4"><span class="flex size-14 items-center justify-center rounded-2xl bg-[#eef2ff] text-[#4f46e5]"><svg class="size-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><path d="M8 7V4h8v3m-11 4h14m-1-4H6a2 2 0 0 0-2 2v10h16V9a2 2 0 0 0-2-2Z"/></svg></span><span class="rounded-full bg-gray-100 px-3 py-1 text-xs font-semibold text-gray-600">Dalam Perencanaan</span></div>
                <div class="mt-7"><p class="text-xs font-semibold uppercase tracking-[0.16em] text-[#4f46e5]"></p><h2 class="mt-2 text-2xl font-bold text-gray-900">Rekrutmen</h2><p class="mt-3 text-sm leading-6 text-gray-500">Modul proses rekrutmen akan dibangun setelah tahapan seleksi dan kebutuhan operasional disepakati.</p></div>
                <div class="mt-auto pt-8"><span class="flex w-full cursor-not-allowed items-center justify-center rounded-xl bg-gray-100 px-5 py-3.5 text-sm font-semibold text-gray-400">Menunggu Finalisasi Flow</span></div>
            </article>
        </section>
