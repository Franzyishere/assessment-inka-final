...
<h2 class="mb-3 text-lg font-semibold text-gray-900">{{ $program->name }}</h2>
<a href="{{ route('asesor.monitoring.index') }}" class="crud-btn-secondary mb-5">Kembali ke Program</a>
