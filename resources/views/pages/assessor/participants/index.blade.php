        ...
        <section class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-theme-xs">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50"><tr>@foreach(['Peserta', 'Status', 'Progres Pengerjaan', 'Pengumpulan'] as $heading)<th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">{{ $heading }}</th>@endforeach</tr></thead>
                    <tbody class="divide-y divide-gray-100">
                        ...
                        @empty
                            <tr><td colspan="4" class="px-5 py-12 text-center text-sm text-gray-500">Belum ada peserta pada program ini.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
