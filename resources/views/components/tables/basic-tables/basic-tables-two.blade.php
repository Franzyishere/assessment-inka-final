                        ...
                        <tr class="border-b border-gray-100 dark:border-white/[0.05]">
                            ...
                            <td class="px-4 sm:px-6 py-3.5">
                                <button type="button" @click="deleteRow(row.id)"
                                    class="inline-flex size-9 items-center justify-center rounded-lg text-gray-500 hover:bg-error-50 hover:text-error-500 dark:text-gray-400 dark:hover:bg-error-500/10 dark:hover:text-error-400"
