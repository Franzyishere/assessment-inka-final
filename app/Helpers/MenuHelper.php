...
class MenuHelper
{
    public static function getMainNavItems(): array
    {
        ...
        return match ($user->role) {
            'super_admin' => self::superAdminItems(),
            'admin' => self::adminItems(),
            'asesor' => self::asesorItems(),
            'peserta_assessment' => self::pesertaAssessmentItems(),
            'peserta_rekrutmen' => self::pesertaRekrutmenItems(),
            default => [],
        };
    }
    ...
    private static function item(string $icon, string $name, string $route): array
    {
        return [
            'icon' => $icon,
            'name' => $name,
